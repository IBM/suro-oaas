...
TARGET_HOST=suro-test.sl.cloud9.ibm.com
TARGET_PATH=/root/suro/deployments/suro-management-app
TARGET_BUILDS=/root/suro/builds
TARGET_PACKAGE=management-ui.tar
TARGET_SERVICE=suro-admin

echo "4. Deploy to target environment: $TARGET_HOST"
# MeteorJS Demo Application

echo "5. Create Tarball $TARGET_PACKAGE and copy to remove location: $TARGET_BUILDS"
rm -rf node_modules
